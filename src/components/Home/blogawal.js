        ...
        <div className='max-w-6xl mx-auto px-5'>
            ...
            <div className='flex flex-wrap justify-center  pb-24 md:space-x-12 lg:space-x-24 mt-16'>
                <div className='w-full md:w-3/12 relative pb-20'>
                    <img src='../asset/jordan.jpg' className='h-[12rem] w-[16rem] object-cover rounded-md absolute left-1/2 -translate-x-1/2'/>
                ...
                <div className='w-full md:w-3/12 relative pb-20'>
                    <img src='../asset/adidasg.jpg' className='h-[12rem] w-[16rem] object-cover rounded-md absolute left-1/2 -translate-x-1/2'/>
                ...
                <div className='w-full md:w-3/12 relative pb-20'>
                    <img src='../asset/airmax97.jpg' className='h-[12rem] w-[16rem] object-cover rounded-md absolute left-1/2 -translate-x-1/2'/>
