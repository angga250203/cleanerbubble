        ...
        <div className='max-w-6xl mx-auto  flex flex-wrap'>
         ...
         <div className='w-full md:w-5/12 md:mt-40 px-5 '>
            ...
            <div className='flex space-x-5 py-5 pb-24'>
                ...
                src='../medsos/ig.png' className='w-7 h-7 cursor-pointer' alt='medsos'/>
                <motion.img
                whileHover={{scale:1.3}}
                src='../medsos/tw.png' className='w-8 h-7 cursor-pointer' alt='medsos'/>
                <motion.img
                whileHover={{scale:1.3}}
                src='../medsos/fb.png' className='w-7 h-7 cursor-pointer' alt='medsos'/>
            </div>
         </div>
       </div>
    </div>
