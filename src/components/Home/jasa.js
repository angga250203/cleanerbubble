        ...
        <div className='flex flex-wrap justify-center md:space-x-12 lg:space-x-24'>
            <div className='w-full md:w-3/12 relative py-5'>
                <Image
                 ...
                 width={350}
                 height={350} src='../asset/cuci5.svg' className='absolute left-1/2 -translate-x-1/2'/>
            ...
            <Image
                 alt="Picture of the author"
                 width={350}
                 height={350} src='../asset/cuci6.svg' className='absolute left-1/2 -translate-x-1/2'/>
            ...
            <Image
                 alt="Picture of the author"
                 width={350}
                 height={350} src='../asset/cuci4.svg' className='absolute left-1/2 -translate-x-1/2'/>
