...
function Jasa() {
  ...
  return (
    ...
    <div className='max-w-6xl mx-auto '>
        ...
        viewport={{ once: true }}
        className='w-full relative md:w-3/12 shadow-2xl mx-5 mb-24 md:mb-0 bg-gray-800 h-[20rem] rounded-[2rem]'>
        <Image
        ...
        <motion.div 
         ...
         transition={{duration:0.5,delay:0.3}}
         viewport={{ once: true }}
        className='w-full md:w-3/12 bg-gray-800 shadow-2xl mx-5 mb-24 md:mb-0 relative h-[20rem] rounded-[2rem]'>
        <Image
        alt="Picture of the author"
        width={100}
        ...
        <motion.div 
         ...
         transition={{duration:0.5,delay:0.3}}
         viewport={{ once: true }}
        className='w-full md:w-3/12 bg-gray-800 shadow-2xl mx-5 mb-5 md:mb-0 relative h-[20rem] rounded-[2rem]'>
        <Image
        alt="Picture of the author"
        width={100}
