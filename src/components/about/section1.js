...
function Section1() {
  return (
    ...
    <motion.div
     ...
     whileTap={{scale:0.8}}
    className='w-full relative md:w-3/12 mb-24 md:mb-0 bg-green-600 h-[25rem] rounded-[2rem] shadow-2xl shadow-green-500/40'>
    <Image
    ...
    <motion.div
     ...
     transition={{duration:0.4}}
     whileTap={{scale:0.8}}
    className='w-full md:w-3/12 relative mb-24 md:mb-0 bg-orange-600 h-[25rem] rounded-[2rem] shadow-2xl shadow-orange-500/40'>
    <Image
    alt="Picture of the author"
    width={170}
    ...
    <motion.div
     ...
     transition={{duration:0.4}}
     whileTap={{scale:0.8}}
    className='w-full md:w-3/12 relative mb-24 md:mb-0 bg-purple-600 h-[25rem] rounded-[2rem] shadow-2xl shadow-purple-500/40'>
    <Image
    alt="Picture of the author"
    width={170}
